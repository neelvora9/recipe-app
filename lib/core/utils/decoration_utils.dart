...
BorderRadius radius([double? radius]) {
  return BorderRadius.all(radiusCircular(radius ?? D.defaultRadius));
}

/// returns Radius
Radius radiusCircular([double? radius]) {
  return Radius.circular(radius ?? D.defaultRadius);
}

ShapeBorder dialogShape([double? borderRadius]) {
  return RoundedRectangleBorder(
    borderRadius: radius(borderRadius ?? D.defaultRadius),
  );
}
...
Decoration boxDecorationRoundedWithShadow(
  ...
  return BoxDecoration(
    boxShadow: defaultBoxShadow(
      shadowColor: shadowColor ?? D.shadowColorGlobal,
      blurRadius: blurRadius ?? D.defaultBlurRadius,
      spreadRadius: spreadRadius ?? D.defaultSpreadRadius,
      offset: offset,
    ),
    color: backgroundColor,
    gradient: gradient,
...
List<BoxShadow> defaultBoxShadow({
  ...
  return [
    BoxShadow(
      color: shadowColor ?? D.shadowColorGlobal,
      blurRadius: blurRadius ?? D.defaultBlurRadius,
      spreadRadius: spreadRadius ?? D.defaultSpreadRadius,
      offset: offset,
    )
